...
public class Clone {
	 ...
	 *
	 */
	public static String cloneRepository(String url, String localPath, String branch, String username, String password) {
		try {
	 ...
	 *
	 */
	public static String cloneSubRepository(String localPath, String username, String password) {
		try {
